...
<title>faturamento_cliente_escritorio.php</title>
  <head>
  </head>
  <body>
  ...
  <?php
   ...
   switch (get_post_action('processa')) {
      case 'processa':
             ...
             WHERE ((codi_cli='$codi_cli') AND (mes_ano='$nome_fatu'))";
                 ...
                 while($linha=mysql_fetch_array($query_1)) {
                      ...
                      if ($linha['codi_cli']<>'' and $linha['co_servico']<>'' and $linha['classe_cep']<>'') {
                          if (($linha['codi_cli']==$cliente) and ($linha['co_servico']==$servi)) {
                              ...
                              VALUES('$nome_fatu','$cliente','$servi','$t_qtd','$valor','$dt_gerado')";
  ...
  <form name="cadastro" id="cadastro" action="faturamento_cliente_escritorio.php" method="post">
	<table width="30%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6495ED">
      ...
      <tr>
        ...
        <tr>
			<td><b>Nome Faturamento :</b></td>
			<td><input name="nome_fatu" type="text" value ="<?php echo "$nome_fatu";?>" size="20" maxlength="20" id="nome_fatu">(Exemplo :FLP082011)</td>
		</tr>
        <tr>
			<td>
				<div align="right">
