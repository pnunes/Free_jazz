<?php
  ...
  function gera_fatura_entregador() {
     ...
     $dt_inicio    =$_SESSION['dt_inicio_m'];
     $dt_fim       =$_SESSION['dt_fim_m'];
     $result = mysql_query("SELECT remessa.n_hawb,date_format(remessa.dt_remessa,'%d/%m/%Y'),serv_ati.descri_se,
