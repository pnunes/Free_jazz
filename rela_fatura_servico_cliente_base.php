  ...
  session_start();
    ...
    switch (get_post_action('gera')) {
         ...
         case 'gera':
              ...
              $vtotal = mysql_db_query($banco_d,$soma,$con) or die ("Não foi possivel acessar o banco");
              ...
              //Gera o total de serviço executado
              $con = mysql_connect($base_d, $usuario_d, $senha_d) or die ("Erro de conexão");
              $res = mysql_select_db($banco_d) or die ("Banco de dados inexistente");
              ...
              require_once("gera_fatura_servico_cliente_base.php");
...
<BODY>
  ...
  <div id="geral" align="center">
   ...
   <table width="70%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6495ED">
        <form name="cadastro" method="POST" action="rela_fatura_servico_cliente_base.php" border="20">
          <tr>
           <td colspan="2">
            <?php
