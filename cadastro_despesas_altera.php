...
<html>
  ...
  <div id="geral" align="center">
    <body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" marginheight="0" marginwidth="0" bgcolor="#FFFFFF">
     ...
     switch (get_post_action('grava','mostra')) {
         ...
         case 'grava':
             ...
             //Altera formato data para gravar na tabela
             ...
             $alteracao = "UPDATE gastos SET valor_gasto='$valor_gasto',data_gasto='$v_data_gasto',
             ano='$ano',observacao='$observacao',competencia='$competencia',codigo_despe='$codigo_despe',
   ...
   <body leftmargin="10" topmargin="10" marginwidth="10" marginheight="10">
    <form name="cadastro" action="cadastro_despesas_altera.php" method="post">
