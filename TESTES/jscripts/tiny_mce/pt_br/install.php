...
/**
 * Strings for component 'install', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   install
...
$string['cliadminusername'] = 'Nome de usuário da conta de administrador';
...
Esta base de dados já deve ter sido criada e um nome de usuário e senha criados para acessá-la. O prefixo de tabela é obrigatório.';
