...
/**
 * Strings for component 'quiz_overview', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
...
$string['overviewreportgraphgroup'] = 'Número de estudantes no Grupo \'{$ a}" Atingir os níveis de avaliação';
...
$string['regradealldrydogroup'] = 'Tentativas de reavaliação ({$ a-> countregradeneeded}) marcadas como necessitando reavaliação no grupo \'{groupname $ a->}\'';
