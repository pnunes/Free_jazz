...
/**
 * Strings for component 'auth_mnet', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   auth_mnet
...
$string['sso_mnet_login_refused'] = 'Nome de usuário {$a->user} não tem permissão para autenticar-se a partir de {$a->host}.';
