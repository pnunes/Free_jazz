...
/**
 * Strings for component 'admin', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   admin
...
$string['confignodefaultuserrolelists'] = 'Esta configuração evita que todos os usuários sejam retornados do banco de dados a partir de chamadas obsoletas de get_course_user, etc., para o curso deste site se o papel padrão fornecer este acesso. Marque isto se você sofrer uma queda de perfomance.';
...
$string['defaulthomepage'] = 'Página padrão (home) para os usuários.';
...
$string['nodefaultuserrolelists'] = 'Não retorne todos os usuários do papel padrão';
