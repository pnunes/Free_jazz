...
/**
 * Strings for component 'backup', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   backup
...
$string['configgeneraluserfiles'] = 'Define o padrão para a inclusão dos arquivos de usuários no backup.';
...
$string['generaluserfiles'] = 'Incluir arquivos de usuários';
...
$string['rootsettinguserfiles'] = 'Incluir os arquivos de usuário';
