...
/**
 * Strings for component 'error', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   error
...
$string['cannotdeletelangcache'] = 'O arquivo de cópia temporária de idioma (cache) não pôde ser apagado. O administrador da plataforma tem que mudar as permissões em dataroot/cache/languages!';
...
$string['invalidqueryparam'] = 'ERRO: Número incorreto de parâmetros de pergunta. Esperado {$a->expected},obtido {$a->actual}.';
...
$string['modulerejectcomment'] = 'O módulo rejeita acrescentar este comentário';
...
$string['unenrolerror'] = 'Ocorreu um erro ao tentar desmatricular esta pessoa';
...
$string['usernotrenamedexists'] = 'Usuário não renomeado - o novo nome de usuário já está em uso';
$string['usernotrenamedmissing'] = 'Usuário não renomeado - impossível achar o nome de usuário antigo';
