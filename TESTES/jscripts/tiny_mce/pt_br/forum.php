...
/**
 * Strings for component 'forum', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   forum
...
$string['forum:managesubscriptions'] = 'Gerenciar subscrições';
...
$string['messageprovider:posts'] = 'Mensagens subscrtitas do fórum';
...
$string['resetsubscriptions'] = 'Excluir todas as subscrições';
...
$string['subscriptionauto'] = 'Auto-subscrição';
$string['subscriptiondisabled'] = 'Subscrição desabilitada';
...
$string['subscriptionmode'] = 'Modo de subsacrição';
