...
/**
 * Strings for component 'auth', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   auth
...
$string['potentialidps'] = 'Você costuma efetuar login em outro lugar antes de chegar aqui ?<br />Escolha uma opção da seguinte lista para efetuar login no seu local habitual:';
