...
/**
 * Strings for component 'group', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   group
...
O tipo de grupo definido no nível do curso é o padrão para todas as atividades do curso. Cada atividade que suporta grupos pode também definir seu próprio tipo de grupo mas, se o tipo de grupo é forçado no nível do curso, o tipo de grupo para cada atividade é ignorada.';
