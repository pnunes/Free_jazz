...
/**
 * Strings for component 'mnet', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   mnet
...
$string['defaultfields'] = 'Os campos definidos globalmente que você está prestes a sobrescrever são:';
