...
/**
 * Strings for component 'assignment', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   assignment
...
$string['invalidassignment'] = 'Tarefa incorreta';
$string['invalidid'] = 'O ID da tarefa estava incorreta';
$string['invalidtype'] = 'Tipo de tarefa incorreto';
