...
/**
 * Strings for component 'blog', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   blog
...
$string['deleteotagswarn'] = 'Você tem certeza que deseja excluir estas etiquetas de todas as mensagens do blog e removê-las do sistema?';
...
$string['filtertags'] = 'Filtrar as etiquetas';
$string['filtertags_help'] = 'Você pode usar esta funcionalidade para filtrar mensagens que quiser utilizar. Se especificar etiquetas, separadas por vírgulas, só as mensagens com estas etiquetas serão copiadas do blog externo';
