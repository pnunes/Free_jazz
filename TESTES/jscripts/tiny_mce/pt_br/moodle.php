...
/**
 * Strings for component 'moodle', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   moodle
...
$string['cookiesenabled_help'] = '<p>Este site usa dois cookies.</p>

<p>O cookie mais importante é o da sessão, normalmente chamado <b>MoodleSession</b>.  Você deve autorizar o seu navegador a aceitar este cookie para que o seu acesso seja contínuo e não se interrompa durante a navegação. Quando você sai do site ou fecha o seu navegador este cookie é automaticamente eliminado.</p>
...
Isto significa que quando você voltar a este site o nome de usuário vai estar preenchido no formulário de acesso. Se você não aceitar este cookie a única consequência vai ser a necessidade de preencher manualmente o formulário sempre que você fizer o login.</p>';
...
$string['courseprofiles'] = 'Perfis de curso';
...
$string['createuserandpass'] = 'Escolha seu nome de usuário e senha';
...
$string['emailpasswordconfirmmaybesent'] = '<p>Se o nome de usuário e o email estiverem corretos um email deve ter sido enviado a você.</p>
...
$string['enterusername'] = 'Insira seu nome de usuário';
...
{$a->extendurl}';
$string['expirynotify_help'] = '<p>Notificação de fim da inscrição</p>';
...
$string['groupmodeforce_help'] = '<p>Forçar o tipo de grupo, no nível da configuração geral do curso, significa que as configurações aplicadas no nível da atividade serão ignoradas. Todas as atividades terão a configuração padrão definida no curso.</p>

<p>Isto pode ser útil quando, por exemplo, o ambiente e os materiais do curso são utilizados por diversos grupos autônomos.</p>';
$string['groupmode_help'] = '<p>As opções de configuração dos tipos de grupo são 3:
   <ul>
      <li>Nenhum grupo - não há divisão dos participantes do curso em grupos</li>
      <li>Grupos Separados - os participantes de cada grupo vêem apenas os outros membros deste grupo e os documentos e informações relacionados apenas a estes membros. As mensagens e os participantes de outros grupos não são visíveis. </li>
...
$string['idnumbermod_help'] = '<p>O Número ID identifica a atividade para fins de cálculo de avaliação.
Se a atividade não estiver inclusa em nenhum cálculo de avaliação então o campo do Número ID pode ser deixado em branco.</p>
<p>O Número ID também pode ser definido na página de edição do cálculo das notas no Relatório de Avaliação, embora ele só possa ser editado na página de atualização da atividade.</p>';
...
$string['invalidusername'] = 'O nome de usuário pode conter somente caracteres alfanuméricos minúsculos, underline (_), hífen (-), ponto (.) ou arroba (@)';
$string['invalidusernameupload'] = 'Nome de usuário inválido';
...
$string['legacythemesaved'] = 'Novo tema legado salvo';
...
$string['notifyloginfailuresmessageend'] = 'Você pode consultar estes logs em {$a}/course/report/log/index.php?id=1&amp;chooselog=1&amp;modid=site_errors .';
...
$string['passwordforgotteninstructions'] = 'Os seus dados devem ser encontrados na base de dados. Por favor, digite <strong>somente</strong> seu nome de usuário ou endereço de email registrado na caixa apropriada. Não há necessidade de introduzir ambos.';
$string['passwordforgotteninstructions2'] = 'Para redefinir sua senha, preencha seu nome de usuário ou seu email abaixo. Se sua conta for encontrada no banco de dados, um email será enviado para seu endereço de email, com as instruções sobre como restabelecer seu acesso.';
...
$string['pluginchecknotice'] = 'As seguintes tabelas mostram os módulos, blocos e filtros detectados em sua instalação do Moodle atual;
Elas indicam quais plugins são  da distribuição padrão e quais são adicionais.
Todos os plugins que não adicionais devem ser atualizados para as suas versões mais recentes antes de continuar esta atualização do Moodle.';
...
$string['searchbyusername'] = 'Buscar por nome de usuário';
...
$string['separatedandconnectedinfo'] = '<p>As mensagens individuais podem ser classificadas segundo uma escala baseada na teoria do 
...
<ul>
  <li>Jim prefere ser tão \'objetivo\'  quanto for possível, evitando sentimentos e emoções. Ele tende a defender as suas próprias idéias em discussões com pessoas que têm opiniões diferentes, e usa a lógica para encontrar falhas nas idéias de seus oponentes. Ele critica todas as idéias novas que não forem fatos comprovados ou cujas fontes não sejam \'respeitáveis\', como livros e professores respeitados, ou de sua experiência direta. Jim é caracterizado por um <strong>saber destacado</strong>.</li>
  <li>Mary é mais sensível à opinião de outras pessoas. Ela favorece a  empatia, tende a ouvir e fazer perguntas, e procura entender o ponto de vista dos outros. Ela aprende compartilhando as experiências que levaram outras pessoas a atingir um determinado conhecimento.  Nas discussões, evita o confronto, e frequentemente tenta ajudar, se encontra o modo de fazê-lo, usando sugestões. Mary é caracterizada por um <strong>saber conectado</strong>.</li>
</ul>

<p>Você notou que nestes exemplos o saber destacado caracteriza um homem e o saber conectado caracteriza uma mulher? Alguns estudos mostram que, estatisticamente, este é o caso frequente, embora o saber de cada pessoa possa estar em qualquer parte do espectro entre estes extremos.

Para que um grupo de aprendizagem colaborativa seja eficaz, o ideal é que cada pessoa seja capaz de proceder segundo os dois modos de saber.

Em certas situações como o fórum, uma mensagem enviada por alguém pode mostrar uma destas características, ou ambas. Pode ser que uma mensagem que expresse saber conectado tenha sido enviada por uma pessoa que normalmente é caracterizada pelo saber destacado, e vice-versa. O objetivo de classificar cada mensagem segundo estes critérios é:
</p>

<ol style="list-style:lower-alpha">
<li>ajudar você a refletir sobre o seu próprio modo de saber, quando lê as mensagens dos outros;</li>
<li>dar um feedback a cada autor, para que saibam como são vistos pelos outros.
</li>
</ol>
...
<hr>
<p>Refer~encias a papers escritos por autores que desenvolveram esta ideias:</p>
<ul>
...
$string['useforlegacytheme'] = 'Usar para navegadores antigos';
$string['useformaintheme'] = 'Usar para navegadores modernos';
...
* Extender a inscrição (individual) - Para extender o acesso de um estudante selecionado ao curso, mesmo quando o período de inscrição estiver definido
* Extender a inscrição (comum) - Para extender o acesso de mais de um estudante ao curso pelo mesmo período';
