  ...
  session_start();
    ...
    switch (get_post_action('gera')) {
         ...
         case 'gera':
              ...
              require_once("gera_fatura_liquido_periodo.php");
              gera_fatura_liquido_periodo();
           break;
         default:
    }
...
<BODY>
  ...
  <div id="geral" align="center">
   ...
   <table width="70%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6495ED">
        <form name="cadastro" method="POST" action="rela_fatura_liquido_periodo.php" border="20">
          <tr>
