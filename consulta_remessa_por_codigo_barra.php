...
?>
<html>
  <title>consulta_remessa_por_codigo_barra.php</title>
  <head>
  ...
  <div id="geral" align="center">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" background="img/blue.jpg">
     <tr>
       ...
       <td width="50%">
         <p align="right"><font face="Arial" size="2" color="#FFFFFF"><b>Consulta HAWB por codigo de barra</b></font></td>
     </tr>
   </table>
   ...
   <form method="POST" name="cadastro_1" action="consulta_remessa_por_hawb.php" border="20" align="center">
       <table width="70%" border="1" cellpadding="5" cellspacing="0" bordercolor="#4169E1">
         ...
         <?php
                 ...
                 case 'mostra':
                     ...
                     if ($cod_barra<>'') {
                        ...
                        If ($total == 0 ) {
                           $n_hawb='';
                           ?>
                           <script language="javascript"> window.location.href=("consulta_remessa_por_codigo_barra.php")
                         ...
                         ?>
                           <script language="javascript"> window.location.href=("consulta_remessa_por_codigo_barra.php")
                               alert('Digite um codigode barras válido!');
                           </script>
                         <?php
                      }
                      break;
           ...
           ?>
        <tr>
           <td><b>Codigo Barra:</b></td>
           <td><input type="text" name="cod_barra" class="campo" id="cod_barra" value ="<?php echo "$cod_barra";?>" size="40" maxlength="40"><input name="mostra" type="submit" value="Mostra"></td></td>
		</tr>
		<?php if ($foco==0) { ?>
