  ...
  session_start();
    ...
    switch (get_post_action('grava')) {
         ...
         case 'grava':
              ...
              WHERE dt_remessa>='$v_dt_inicio' AND dt_remessa<='$v_dt_fim' AND codi_cli='$cliente'";
...
<HTML>
<HEAD>
 <TITLE>corrige_classe_cep_movimento.php</TITLE>
</HEAD>
<BODY>
  <style>
  ...
  <div id="geral" align="center">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" background="img/blue.jpg">
     <tr>
       ...
       <td width="50%">
         <p align="right"><font face="Arial" size="2" color="#FFFFFF"><b>Corrige Classe CEP Movimento</b></font></td>
     </tr>
   </table>
   ...
   <table width="50%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6495ED" align="center">
        <form name="cadastro" method="POST" action="corrige_classe_cep_movimento.php" border="20">
          <tr>
            <td><b>Cliente :</b></td>
            <td>
            <?php
               ...
               $resultado = mysql_query ("SELECT cnpj_cpf,nome FROM cli_for WHERE ativo='S' and catego='C'");
