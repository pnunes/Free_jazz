  ...
  session_start();
    ...
    switch (get_post_action('gera')) {
         ...
         case 'gera':
               ...
               $pega=mysql_query("SELECT nome FROM regi_dep
               ...
               $_SESSION['nome_escritorio_m']   =$nome_escritorio;
               ...
               require_once("gera_lista_pendente_escritorio.php");
  ...
  <div id="geral" align="center">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" background="img/blue.jpg">
     <tr>
       ...
       <td width="50%">
         <p align="right"><font face="Arial" size="2" color="#FFFFFF"><b>Relatório HAWB Pendente Por Base</b></font></td>
     </tr>
   </table>
   ...
   <table width="70%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6495ED">
        <form name="cadastro" method="POST" action="rela_hawb_pendente_escritorio.php" border="20">
          <tr>
           <td colspan="2">
            <?php
