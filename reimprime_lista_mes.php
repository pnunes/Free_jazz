  ...
  session_start();
    ...
    switch (get_post_action('gera')) {
         ...
         case 'gera':
               ...
               require_once("gera_lista_dia.php");
               gera_lista_dia();
           break;
         default:
    }
...
<HTML>
<HEAD>
 <TITLE>imprime_lista_mes.php</TITLE>
</HEAD>
<BODY>
  <style>
  ...
  <div id="geral" align="center">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" background="img/blue.jpg">
     <tr>
       ...
       <td width="50%">
         <p align="right"><font face="Arial" size="2" color="#FFFFFF"><b>Reimprime Lista de Entrega Mês em Curso</b></font></td>
     </tr>
   </table>
   ...
   <table width="70%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6495ED">
        <form name="cadastro" method="POST" action="reimprime_lista.php" border="20">
          <tr>
           <td colspan="2">
            <?php
              ...
              if ($adm_m=='N') {
                   echo "<center><Font size=\"2\" face=\"ARIAL\">Selecione Lista...:</font>";
                   ...
                   AND (pessoa.ativo='S')
                   AND(substring(controle_lista.dt_lista,1,7='$mes_ano'))
                   ORDER BY pessoa.nome");
