...
<html>
  ...
  <div id="geral" align="center">
   ...
   <table width="80%" heigth="300" align="center">
     <tr>
       <td>
         <form method="POST" action="noticia_site_exclui.php" border="20">
            <?php
  ...
  <?php
     switch (get_post_action('exclui','mostra')) {
         case 'mostra':
             ...
             $verifi="SELECT codigo,titulo,assunto,date_format(data_publicacao,'%d/%m/%Y')
         ...
         case 'exclui':
             ...
             $alteracao = "DELETE FROM t_noticias  WHERE codigo='$codigo'";
  ...
  <form name="cadastro" action="noticia_site_exclui.php" method="post">
