...
?>
<html>
  <title>Cadastro_rotina_sistema_exclui.php</title>
  <head>
  <body>
   <style>
  ...
  <div id="geral" align="center">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" background="img/blue.jpg">
     <tr>
       ...
       <td width="50%">
         <p align="right"><font face="Arial" size="2" color="#FFFFFF"><b>Cadastro de Rotinas do Sistema - Exclusão</b></font></td>
     </tr>
  ...
  <table width="80%" heigth="300" align="center">
     <tr>
       <td>
         <form method="POST" action="cadastro_rotina_sistema_exclui.php" border="20">
            <?php
  ...
  <?php
     switch (get_post_action('exclui','mostra')) {
         ...
         case 'exclui':
             ...
             $alteracao = "DELETE FROM cad_rotinas WHERE programa='$programa'";
  ...
  <form name="cadastro" action="cadastro_rotina_sistema_exclui.php" method="post">
