...
<HTML>
 <HEAD>
  <TITLE>detalhes_entrega_inclui.php</TITLE>
...
<BODY>
  ...
  switch (get_post_action('grava','mostra')) {
         case 'mostra':
             ...
             $pega_dados="SELECT cod_barra FROM remessa WHERE n_hawb='$n_hawb'";
             $query = mysql_db_query($banco_d,$pega_dados,$con) or die ("Não foi possivel acessar o banco");
         ...
         case 'grava':
             ...
             if ($n_hawb<>'') {
                 ...
                 $incluir = "INSERT INTO controle_reentrega (n_hawb,ocorrencia,dt_evento,cod_barra,ordem)
                 VALUES ('$n_hawb','$ocorrencia','$v_dt_evento','$cod_barra','9')";
                 ...
                 ?>
                  <script language="javascript"> window.location.href=("detalhes_entrega_inclui.php")
                     alert('Você precisa informar o número da HAWB !');
                  </script>
                 <?php
             }
         break;
 ...
 ?>
<form name="cadastro" action="detalhes_entrega_inclui.php" method="post">
