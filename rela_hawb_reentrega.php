  ...
  session_start();
    ...
    switch (get_post_action('gera')) {
         ...
         case 'gera':
              ...
              require_once("gera_hawb_reentrega.php");
              gera_hawb_reentrega();
           break;
         default:
    }
...
<HTML>
<HEAD>
 <TITLE>rela_hawb_reentrega.php</TITLE>
</HEAD>
<BODY>
  <style>
  ...
  <div id="geral" align="center">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" background="img/blue.jpg">
     <tr>
       ...
       <td width="50%">
         <p align="right"><font face="Arial" size="2" color="#FFFFFF"><b>Relatório de HAWB´s para Reentrega</b></font></td>
     </tr>
   </table>
   ...
   <table width="70%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6495ED">
        <form name="cadastro" method="POST" action="rela_hawb_reentrega.php" border="20">
          <tr>
