...
<HEAD>
 ...
 <style>
  ...
  <body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" marginheight="0" marginwidth="0" bgcolor="#FFFFFF">
   ...
   <form method="POST" name="cadastro" action="mostra_detalhes_operador.php" border="20" align="center">
   <?php
      ...
      <tr>
        ...
        <td>
          <?php
           ...
           <?php
            $sql2 = "SELECT matricula,nome FROM pessoa";
   ...
   <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#4169E1">
     <tr>
       ...
       <td colspan="8" align="center"><font face="arial" size="2"><b>OPERAÇÕES FEITAS NO SISTEMA - POR :<?php echo "$nome_operador" ?></b></font></td>
     </tr>
     <tr>
       <td width="19%" align="center"><b>OPERAÇÃO EXECUTADA</b></td>
       <td width="10%" align="center"><b>N. HAWB</b></td>
       <td width="15%" align="center"><b>SERVIÇO</b></td>
       <td width="10%" align="center"><b>REMESSA</b></td>
       <td width="15%" align="center"><b>CLIENTE</b></td>
       <td width="8%" align="center"><b>DATA</b></td>
       <td width="8%" align="center"><b>HORA</b></td>
       <td width="30%" align="center"><b>ROTINA OPERADA</b></td>
     </tr>
     <?php
      $operador  =$_SESSION['operador_m'];
      mysql_connect($base_d, $usuario_d, $senha_d) or die ("Erro de conexão");
      ...
      serv_ati.descri_se,cli_for.nome,log_operacao_sistema.remessa
      FROM log_operacao_sistema,cad_rotinas,serv_ati,cli_for
      WHERE ((log_operacao_sistema.rotina=cad_rotinas.programa)
      AND (log_operacao_sistema.servico=serv_ati.codigo_se)
      AND (log_operacao_sistema.codi_cli=cli_for.cnpj_cpf)
      AND (log_operacao_sistema.matricula='$operador')
      AND (data>='$v_data_ini')
      AND (data<='$v_data_fim'))
      ORDER BY log_operacao_sistema.remessa,log_operacao_sistema.data,log_operacao_sistema.hora");
      $total = mysql_num_rows($resultado);
      ...
      for($i=0; $i<$total; $i++){
	     ...
	     $remessa         =$dados[7];
	     echo "<tr>";
	     echo "<td width=\"19%\" align=\"left\"><font size=\"2\" face=\"arial\">$tarefa</font></td>";
	     echo "<td width=\"10%\"><font size=\"2\" face=\"arial\">$n_hawb</font></td>";
	     echo "<td width=\"15%\"><font size=\"2\" face=\"arial\">$servico</font></td>";
	     echo "<td width=\"10%\"><font size=\"2\" face=\"arial\">$remessa</font></td>";
	     echo "<td width=\"15%\"><font size=\"2\" face=\"arial\">$cliente</font></td>";
	     echo "<td width=\"8%\"><font size=\"2\" face=\"arial\">$data</font></td>";
         echo "<td width=\"8%\"><font size=\"2\" face=\"arial\">$hora</font></td>";
         echo "<td width=\"30%\"><font size=\"2\" face=\"arial\">$progra</font></td>";
         echo "</tr>";
       }
     ?>
</table>
