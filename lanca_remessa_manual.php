...
?>
<html>
  <title>lanca_remessa_manual.php</title>
  <head>
  </head>
  <body>
  <div id="geral" align="center">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" background="img/blue.jpg">
     <tr>
       ...
       <td width="50%">
         <p align="right"><font face="Arial" size="2" color="#FFFFFF"><b>Remessa Manual - Lançamento</b></font></td>
     </tr>
   </table>
   </table>
  ...
  <?php
    ...
    switch (get_post_action('grava','busca','nova')) {
      ...
      case 'grava':
        ...
        estado_desti,dt_remessa,qtdade,comple_desti)
        values('$codi_cli','$n_remessa','$escritorio','$tipo_servi','$cod_barra','$codigo_desti',
        '$nome_desti','$cep_desti','$rua_desti','$numero_desti','$bairro_desti','$cidade_desti',
        '$estado_desti','$v_dt_remessa','$qtdade','$comple_desti')";
  ...
  <form name="cadastro" id="cadastro" action="lanca_remessa_manual.php" method="post" onSubmit="return limpa()">
	<table width="50%" border="1" cellpadding="5" cellspacing="0" bordercolor="#4169E1">
		...
		<tr>
			...
			<td><input type="text" name="n_remessa" value ="<?php echo "$v_n_remessa";?>" size="14" maxlength="14" id="n_remessa"></td>
		</tr>
		<tr>
