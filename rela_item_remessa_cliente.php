  ...
  session_start();
    ...
    switch (get_post_action('gera')) {
         ...
         case 'gera':
              ...
              require_once("gera_relat_item_remessa_cliente.php");
              gera_relat_item_remessa_cliente();
           break;
         default:
    }
...
<BODY>
  ...
  <div id="geral" align="center">
   ...
   <table width="70%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6495ED">
        <form name="cadastro" method="POST" action="rela_item_remessa_cliente.php" border="20">
          <tr>
           <td colspan="2">
            <?php
