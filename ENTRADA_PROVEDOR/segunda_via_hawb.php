  ...
  <div id="geral" align="center">
   ...
   <form method="POST" name="cadastro" action="segunda_via_hawb.php" border="20">
       <table width="80%" border="1" cellpadding="3" cellspacing="0" bordercolor="#4169E1" align="center">
                 ...
                 case 'mostra':
                     ...
                     if ($n_hawb<>'') {
                        ...
                        If ($total == 0 ) {
                           ...
                           $resultado = mysqli_query ($con,"SELECT nome,estado
                           FROM regi_dep
						   ...
						   if(isset($nome_escri)) {
						       ...
						       $_SESSION['estado_regi_h']  =$estado_regi;
                           }
                           ...
                           if(isset($nome_entrega)) {
							   $_SESSION['nome_entrega_h']  =$nome_entrega; 
						   }
        ...
        <tr>
           <td><INPUT type=button value="Imprime Segunda Via HAWB"
               onClick="window.open('imagem_hawb.php','janela_1',
