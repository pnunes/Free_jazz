...
?>
<html>
  <title>Remessa_manual_altera.php</title>
  <head>
  </head>
  <body>
  <div id="geral" align="center">
   ...
   <table width="80%" heigth="300" align="center">
     <tr>
       <td>
         <form method="POST" action="remessa_manual_altera.php" border="20">
            <?php
               //echo "Depto :$depto_m";
  ...
  <?php
    ...
    switch (get_post_action('grava','busca','mostra')) {
      case 'mostra':
      ...
      case 'grava':
        ...
        //$v_codigo_destij    =str_replace('.','',$codigo_desti);
        //$vv_codigo_desti    =str_replace('/','',$v_codigo_desti);
        //$vvv_codigo_desti   =str_replace('-','',$vv_codigo_desti);
        ...
        estado_desti='$estado_desti',dt_remessa='$v_dt_remessa',comple_desti='$comple_desti'
  ...
  <form name="cadastro" id="cadastro" action="remessa_manual_altera.php" method="post" onSubmit="return limpa()">
