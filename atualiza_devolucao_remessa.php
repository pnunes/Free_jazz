...
<html>
  ...
  <div id="geral" align="center">
   ...
   <form method="POST" name="cadastro_1" action="consulta_remessa_por_hawb.php" border="20" align="center">
       <table width="70%" border="1" cellpadding="5" cellspacing="0" bordercolor="#4169E1">

         <?php
              switch (get_post_action('mostra','grava')) {
                 ...
                 case 'mostra':
                     ...
                     if ($n_hawb<>'') {
                        ...
                        date_format(dt_baixa,'%d/%m/%Y'),volta_lista,date_format(dt_devolucao,'%d/%m/%Y')
                        FROM remessa
                        WHERE n_hawb='$n_hawb'";
                      ...
                      case 'grava':
                           ...
                           $dt_devolucao  = explode("/",$dt_devolucao);
                           $v_dt_devolucao = $dt_devolucao[2]."-".$dt_devolucao[1]."-".$dt_devolucao[0];

                           $con = mysql_connect($base_d, $usuario_d, $senha_d) or die ("Erro de conexão");
                           $res = mysql_select_db($banco_d) or die ("Banco de dados inexistente");

                           $alteracao = "UPDATE remessa SET volta_lista='$volta_lista',
        ...
        <tr>
          ...
          <td>
            <input type="text" name="dt_devolucao" value ="<?php echo "$dt_devolucao";?>" size="12" maxlength="12" id="dt_devolucao">
            <input TYPE="button" NAME="btndt_devolucao" VALUE="..." Onclick="javascript:popdate('document.cadastro.dt_devolucao','pop1','150',document.cadastro.dt_devolucao.value)">
