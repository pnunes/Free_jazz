  ...
  session_start();
    ...
    switch (get_post_action('gera','seleciona')) {
         ...
         case 'gera':
              ...
              require_once("gera_fatura_entregador.php");
              gera_fatura_entregador();
           break;
         default:
    }
...
<BODY>
  ...
  <div id="geral" align="center">
   ...
   <table width="70%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6495ED">
        <form name="cadastro" method="POST" action="rela_fatura_entregador.php" border="20">
         <tr>
           <td colspan="2">
			 <?php
              $adm     = $_SESSION['adm_m'];
              ...
              if ($adm=='N') {
                  ...
                  $entregador   =$_SESSION['matricula_m'];
                  mysql_connect($base_d, $usuario_d, $senha_d) or die ("Erro de conexão");
                  mysql_select_db($banco_d) or die ("Banco de dados inexistente");
                  ?>
                  <select name="entregador">
                  <?php
                   $resultado ="SELECT cnpj_cpf,nome FROM cli_for WHERE ((cnpj_cpf='$entregador') and (uf='$estado'))";
