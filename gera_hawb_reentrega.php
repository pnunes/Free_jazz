<?php
  ...
  function gera_hawb_reentrega() {
     ...
     $pdf->SetCabecalho(" HAWB   N. REMESSA    NOME DESTINATÁRIO                       RUA                                                        NUM.     BAIRRO                CIDADE               LISTA");
     $pdf->Open();
     $pdf->AddPage();
     $pdf->SetFont('Arial', '', 7);
    ...
    // $remessa    =$_SESSION['remessa_m'];
     ...
     $result = mysql_query("SELECT n_hawb,n_remessa,nome_desti,
     rua_desti,numero_desti,bairro_desti,cidade_desti,nu_lista
     FROM remessa
