...
<html>
  ...
  <div id="geral" align="center">
   ...
   <table width="80%" heigth="300">
    <?php
       ...
       switch (get_post_action('grava','busca','localiza','ativa_ser','gera','ativa_cli')) {
		  ...
		  case 'gera':
			 ...
			 if (strlen($numero)==1) {
				$n_remessa= sprintf("%07d", $numero.$mes_ano);
			 }
						 ...
						 If ($achou > 0 ) {
							...
							if ($rua_desti=='' or $bairro_desti=='' or $cidade_desti=='' or $estado_desti=='' or $n_remessa=='' or $n_hawb=='') {
							   ...
							   <?php
								...
								/*echo "<p>Dados para gravar : $codi_cli,$n_remessa,$escritorio,$codi_barra,
								$codi_servi,$codigo_desti,$nome_desti,$cep_desti,$rua_desti,
								$numero_desti,$bairro_desti,$cidade_desti,$estado_desti,
								$v_dt_remessa,$qtdade,$comple_desti,$n_hawb,$classe_cep,
								$valor,$codi_servi,$estatus,$cnpj_desti";*/
								...
								VALUES('$codi_cli','$n_remessa','$escritorio','$codi_barra','$codi_servi','$codigo_desti','$nome_desti',								'$cep_desti',
								'$rua_desti','$numero_desti','$bairro_desti','$cidade_desti','$estado_desti','$v_dt_remessa','$qtdade',
	...
	//Carrega os campos com os dados pegos após digitar o codigo de barras
