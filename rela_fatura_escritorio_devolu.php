  ...
  session_start();
    ...
    switch (get_post_action('gera')) {
         ...
         case 'gera':
              ...
              ///////////////////////GERA O TOTAL EM VALOR DAS HAWBS ENTREGUES //////////////////////////////////
              $soma = "SELECT sum(qtdade*valor) AS tot_fatu
              FROM remessa
              WHERE ((escritorio='$escritorio')
              AND (dt_envio>='$v_dt_inicio')
              AND (dt_envio<='$v_dt_fim'))";
              $vtotal = mysql_db_query($banco_d,$soma,$con) or die ("Não foi possivel acessar o banco (soma)");
              ...
              $pega = "SELECT nome FROM regi_dep WHERE codigo='$escritorio'";
              ...
              require_once("gera_fatura_escritorio_devolu.php");
...
<BODY>
  ...
  <div id="geral" align="center">
   ...
   <table width="70%" border="1" cellpadding="5" cellspacing="0" bordercolor="#6495ED">
        <form name="cadastro" method="POST" action="rela_fatura_escritorio_devolu.php" border="20">
          <tr>
           <td colspan="2">
            <?php
               echo "<center><Font size=\"2\" face=\"ARIAL\">Selecione Escritório...:</font>";
